...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchAndDisplayChats(groupId){
       ...
       try{
        ...
        async function loadOlderMessages(groupId){
            ...
            const div = document.getElementById('oldmessagebtn')
            div.innerHTML = ""
            alert('No chats')
        }
        }
    ...
    async function fetchGroups() {
        ...
        try {
            ...
            // Define getCurrentGroupId function outside the loop but within the fetchGroups function
            let currentGroupId = null;
            function getCurrentGroupId() {
                return currentGroupId;
            }
    
            // Add event listeners for uploadButton and sendBtn outside the loop
            ...
            groups.forEach(group => {
                ...
                link.addEventListener("click", async () => {
                    ...
                    // Clear previous content of buttonDiv and show/hide elements as needed
                    buttonDiv.innerHTML = "";
            ...
            // Set a default value for currentGroupId in case no link is clicked initially
            // if (groups.length > 0) {
            //     currentGroupId = groups[0].id; // Set to the ID of the first group initially
            // }
        } catch (error) {
